...
export function BannedNotification(): React.ReactNode {
  ...
  return (
    <Dialog.Root open={notification === 'banned'} onOpenChange={() => {}}>
      <Dialog.Portal>
        ...
        >
          ...
          <Dialog.Description className="mt-2 text-sm text-text-secondary">
            The server owner has banned your account. You cannot log in or create new accounts.
          </Dialog.Description>
